...
from models.amazonapi.adapi.common.reports import AdReport, AdReportConfiguration, AdReportRequest, ReportStatus, TimeUnit, ReportFormat
from models.amazonapi.errors import APIError
from models.extras.amazon_daily_report import AmazonAdReport, AmazonAdReportDB, MarketplaceObjectForReport
from models.enums import AdProduct, AdReportType, CollectionType
...
class AmazonAdsReportManager:
    ...
    async def processAdReports(self, reports: list[AmazonAdReportDB], reportUtil: ReportUtil, dbClient: DbClient, reportId: PyObjectId):
    ...
    async def __convertAdReport(self, reportType: AdReportType, dataStr: str):
        from amazon_daily_report.reports.report_types.ad.AdsReportConvertor import AdsReportConvertor
        ...
        await self.reportUtil.update(self.dbClient, CollectionType.ADV, data, self.reportId)
