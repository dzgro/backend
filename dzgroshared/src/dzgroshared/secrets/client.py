...
class SecretManager:
    ...
    def __init__(self, env: ENVIRONMENT):
        ...
        envname = ENVIRONMENT.DEV.name if env == ENVIRONMENT.LOCAL else env.name
    ...
    def build_mongo_uri(self, env: ENVIRONMENT, secrets: dict):
        ...
        MONGO_USER = f'{env.value}-user' if env!=ENVIRONMENT.LOCAL else f'{ENVIRONMENT.DEV.value}-user'
