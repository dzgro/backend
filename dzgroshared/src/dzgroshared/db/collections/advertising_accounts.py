...
from dzgroshared.models.enums import CollectionType, CountryCode 
from dzgroshared.models.collections.advertising_accounts import AdAccountsList, AdvertisingAccountRequest, AdvertisingAccountUrlResponse, AdAccount, AdvertisingAccount, AdvertisingAccountList
...
class AdvertisingAccountsHelper:
    ...
    async def getAccountApiClient(self, id: PyObjectId):
        ...
        return AdApiClient(**{**data[0], "client_id":self.client.secrets.ADS_CLIENT_ID, "client_secret":self.client.secrets.ADS_CLIENT_SECRET, "isad": True})
