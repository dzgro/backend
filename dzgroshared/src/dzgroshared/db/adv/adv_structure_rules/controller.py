...
from .pipelines import GetStructureScore, GetAdGroupsViolations, GetAdsForAdGroup, GetMatchTypesForAdGroup, GetTargetsForAdGroup
from dzgroshared.db.enums import CollectionType
from .model import AdGroupOptimizationRequest, AdGroupOptimizationResponse, RemoveMultipleAdsForm, RemoveMatchTypesForm, RemoveKeywordStuffingForm
