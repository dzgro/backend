...
class AnalyticsPeriod(str, Enum):
    ...
    LAST_MONTH_COMPLETE = "Last Month (Complete)"
    
class AnalyticsGroupLabel(str, Enum):
    SALES = "Sales"
    AD = "Advertisement"
    TRAFFIC = "Traffic"
...
class CollectionType(str,Enum):
    ...
    DAILY_REPORT_GROUP = 'daily_reports_group'
    DAILY_REPORT_ITEM = 'daily_reports_item'
    ...
    PERFORMANCE_PERIOD_RESULTS = 'performance_period_results'
...
class AnalyticsMetric(str, Enum):
    ...
    ORDERS = "orders"
    FBA_CANCELLED_ORDERS = "fbacancelledorders"
    FBM_CANCELLED_ORDERS = "fbmcancelledorders"
    CANCELLED_ORDERS = "cancelledorders"
    FBM_NET_ORDERS = "fbmnetorders"
    FBA_NET_ORDERS = "fbanetorders"
    NET_ORDERS = "netorders"
    FBA_QUANTITY = "fbaquantity"
    FBM_QUANTITY = "fbmquantity"
    QUANTITY = "quantity"
    FBA_RETURN_QUANTITY = "fbareturneuantity"
    FBM_RETURN_QUANTITY = "fbmreturnquantity"
    ...
    FBA_PAYOUT_PER_UNIT = "fbapayoutperunit"
    FBM_PAYOUT_PER_UNIT = "fbmpayoutperunit"
    PAYOUT_PER_UNIT = "payoutperunit"
    FBA_RETURN_PERCENTAGE = "fbareturnpercentage"
    FBM_RETURN_PERCENTAGE = "fbmreturnpercentage"
    RETURN_PERCENTAGE = "returnpercentage"
    FBA_NET_QUANTITY = "fbanetquantity"
    FBM_NET_QUANTITY = "fbmnetquantity"
    ...
    MOBILE_APP_SESSIONS = "mobileappsessions"
    BROWSER_SESSIONS_PERCENTAGE = "browsersessionspercentage"
    MOBILE_APP_SESSIONS_PERCENTAGE = "mobileappsessionspercentage"
    UNIT_SESSIONS = "unitsessions"
    UNIT_SESSION_PERCENTAGE = "unitsessionpercentage"
    PAGE_VIEWS = "pageviews"
    BROWSER_PAGE_VIEWS = "browserpageviews"
    MOBILE_APP_PAGE_VIEWS = "mobileapppageviews"
    BROWSER_PAGE_VIEWS_PERCENTAGE = "browserpageviewspercentage"
    MOBILE_APP_PAGE_VIEWS_PERCENTAGE = "mobileapppageviewspercentage"
    BUY_BOX_VIEWS = "buyboxviews"
    BUY_BOX_PERCENTAGE = "buyboxpercentage"
    ORGANIC_SALES_PERCENTAGE = "organicsalespercentage"
    TACOS = "tacos"
