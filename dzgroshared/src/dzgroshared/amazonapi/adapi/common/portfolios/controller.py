...
from .model import ListPortfoliosRequestContent, ListPortfoliosResponseContent, CreatePortfoliosRequestContent, CreatePortfoliosResponseContent, UpdatePortfoliosRequestContent, UpdatePortfoliosResponseContent
