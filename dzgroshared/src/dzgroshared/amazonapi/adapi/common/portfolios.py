...
from dzgroshared.models.amazonapi.adapi.common.portfolios import ListPortfoliosRequestContent, ListPortfoliosResponseContent, CreatePortfoliosRequestContent, CreatePortfoliosResponseContent, UpdatePortfoliosRequestContent, UpdatePortfoliosResponseContent
