...
#   filename:  campaign_negative_targeting_clauses.json
#   timestamp: 2025-07-23T04:03:34+00:00
...
class SponsoredProductsDeleteSponsoredProductsCampaignNegativeTargetingClausesRequestContent(
    BaseModel
):
    class Config:
        validate_by_name= True

    campaign_negative_target_id_filter: SponsoredProductsObjectIdFilter = Field(
        ..., alias='campaignNegativeTargetIdFilter'
    )


class SponsoredProductsCreateOrUpdateNegativeTargetingExpressionPredicateType(Enum):
    """
...
class SponsoredProductsNegativeTargetingExpressionPredicateType(Enum):
    """
    The type of nagative targeting expression. You can only specify values for the following predicates:
    | Predicate | Description |
    | --- | --- |
...
class SponsoredProductsNegativeTargetingExpressionPredicate(BaseModel):
    ...
    type: SponsoredProductsNegativeTargetingExpressionPredicateType | None = None
    value: str | None = Field(None, description='The expression value')
...
class SponsoredProductsUpdateCampaignNegativeTargetingClause(BaseModel):
    ...
    expression: (
        list[SponsoredProductsCreateOrUpdateNegativeTargetingExpressionPredicate] | None
    ) = Field(
        None,
...
class SponsoredProductsCreateSponsoredProductsCampaignNegativeTargetingClausesRequestContent(
    BaseModel
):
    class Config:
        validate_by_name= True

    campaign_negative_targeting_clauses: list[
        SponsoredProductsCreateCampaignNegativeTargetingClause
    ] = Field(
        ...,
        alias='campaignNegativeTargetingClauses',
...
class SponsoredProductsListSponsoredProductsCampaignNegativeTargetingClausesRequestContent(
    BaseModel
):
    class Config:
        validate_by_name= True
    ...
    campaign_negative_target_id_filter: SponsoredProductsObjectIdFilter | None = Field(
        None, alias='campaignNegativeTargetIdFilter'
    )
...
class SponsoredProductsUpdateSponsoredProductsCampaignNegativeTargetingClausesRequestContent(
    BaseModel
):
    class Config:
        validate_by_name= True
...
class SponsoredProductsCampaignNegativeTargetsAccessError(BaseModel):
    ...
    error_value: SponsoredProductsCampaignNegativeTargetsAccessErrorSelector = Field(
        ..., alias='errorValue'
    )
...
class SponsoredProductsCampaignNegativeTargetingClause(BaseModel):
    ...
    target_id: str = Field(..., alias='targetId', description='The target identifier')
    resolved_expression: list[SponsoredProductsNegativeTargetingExpressionPredicate] = (
        Field(
            ...,
    ...
    extended_data: (
        SponsoredProductsCampaignNegativeTargetingClauseExtendedData | None
    ) = Field(None, alias='extendedData')
...
class SponsoredProductsCampaignNegativeTargetsAccessExceptionResponseContent(BaseModel):
    ...
    message: str = Field(..., description='Human readable error message')
    errors: list[SponsoredProductsCampaignNegativeTargetsAccessError] | None = None


class SponsoredProductsListSponsoredProductsCampaignNegativeTargetingClausesResponseContent(
    BaseModel
):
    class Config:
        validate_by_name= True
    ...
    campaign_negative_targeting_clauses: (
        list[SponsoredProductsCampaignNegativeTargetingClause] | None
    ) = Field(
        None, alias='campaignNegativeTargetingClauses', max_length=1000, min_length=0
    )
...
class SponsoredProductsCampaignNegativeTargetsMutationError(BaseModel):
    ...
    error_type: str = Field(..., alias='errorType', description='The type of the error')
    error_value: SponsoredProductsCampaignNegativeTargetsMutationErrorSelector = Field(
        ..., alias='errorValue'
    )
...
class SponsoredProductsCampaignNegativeTargetsMutationExceptionResponseContent(
    BaseModel
):
    """
    ...
    code: SponsoredProductsInvalidArgumentErrorCode
    message: str = Field(..., description='Human readable error message')
    errors: list[SponsoredProductsCampaignNegativeTargetsMutationError] | None = None
...
class SponsoredProductsCampaignNegativeTargetingClauseSuccessResponseItem(BaseModel):
    ...
    campaign_negative_targeting_clause_id: str | None = Field(
        None,
        alias='campaignNegativeTargetingClauseId',
        description='the CampaignNegativeTargets ID',
    )
    campaign_negative_targeting_clauses: (
        SponsoredProductsCampaignNegativeTargetingClause | None
    ) = Field(None, alias='campaignNegativeTargetingClauses')
    index: int = Field(
        ...,
        description='the index of the CampaignNegativeTargets in the array from the request body',
        ge=0,
...
class SponsoredProductsBulkCampaignNegativeTargetingClauseOperationResponse(BaseModel):
    ...
    success: (
        list[SponsoredProductsCampaignNegativeTargetingClauseSuccessResponseItem] | None
    ) = Field(None, max_length=1000, min_length=0)
    error: (
        list[SponsoredProductsCampaignNegativeTargetingClauseFailureResponseItem] | None
    ) = Field(None, max_length=1000, min_length=0)


class SponsoredProductsCreateSponsoredProductsCampaignNegativeTargetingClausesResponseContent(
    BaseModel
):
    class Config:
        validate_by_name= True
    ...
    ) = Field(..., alias='campaignNegativeTargetingClauses')


class SponsoredProductsUpdateSponsoredProductsCampaignNegativeTargetingClausesResponseContent(
    SponsoredProductsCreateSponsoredProductsCampaignNegativeTargetingClausesResponseContent
):
    pass


class SponsoredProductsDeleteSponsoredProductsCampaignNegativeTargetingClausesResponseContent(
    SponsoredProductsCreateSponsoredProductsCampaignNegativeTargetingClausesResponseContent
):
    pass
