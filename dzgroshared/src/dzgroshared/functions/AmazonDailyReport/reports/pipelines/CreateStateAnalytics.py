...
def createOtherCollateTypes():
    return [
        ...
        '$merge': {
            'into': CollectionType.STATE_ANALYTICS,
        }
    }
    ]

def refreshPreviousStateAnalytics(marketplace: ObjectId, dates: StartEndDate):
    pipeline = [
    ...
    return pipeline+createOtherCollateTypes()


def freshPipeline(marketplace: ObjectId, dates: StartEndDate):
