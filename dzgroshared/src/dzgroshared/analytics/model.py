...
METRIC_DETAILS: list[MetricDetail] = [
    MetricDetail( metric=AnalyticsMetric.TOTAL, ispercentage=False, isCurrency=True, label="Total Revenue"),
    MetricDetail( metric=AnalyticsMetric.NET_REVENUE, ispercentage=False, isCurrency=True, label="Net Revenue", description="Total value of orders after returns including tax"),
    MetricDetail( metric=AnalyticsMetric.FBA, ispercentage=False, isCurrency=True, label="FBA/Flex++", description="Amazon Fulfillment via FBA or Flex or others similar"),
    MetricDetail( metric=AnalyticsMetric.FBM, ispercentage=False, isCurrency=True, label="Merchant Fulfilled", description="Easy Ship or Self Ship"),
    ...
    MetricDetail( metric=AnalyticsMetric.FBM_NET_REVENUE, ispercentage=False, isCurrency=True, label="FBM Net Revenue", description="Total value of FBM orders after returns including tax"),
    MetricDetail( metric=AnalyticsMetric.FBA_NET_REVENUE, ispercentage=False, isCurrency=True, label="FBA Net Revenue", description="Total value of FBA orders after returns including tax"),
    MetricDetail( metric=AnalyticsMetric.REVENUE, ispercentage=False, isCurrency=True, label="Gross Revenue", description="Total value of purchases including tax" ),
    MetricDetail( metric=AnalyticsMetric.FBA_REVENUE, ispercentage=False, isCurrency=True, label="FBA Revenue", description="Total value of FBA orders including tax" ),
    MetricDetail( metric=AnalyticsMetric.FBM_REVENUE, ispercentage=False, isCurrency=True, label="FBM Revenue", description="Total value of FBM orders including tax" ),
    MetricDetail( metric=AnalyticsMetric.RETURN_VALUE, ispercentage=False, isCurrency=True, label="Return Value", description="Total value of return orders including tax"),
    MetricDetail( metric=AnalyticsMetric.FBA_RETURN_VALUE, ispercentage=False, isCurrency=True, label="FBA Return Value", description="Total value of FBA return orders including tax"),
    MetricDetail( metric=AnalyticsMetric.FBM_RETURN_VALUE, ispercentage=False, isCurrency=True, label="FBM Return Value", description="Total value of FBM return orders including tax"),
    ...
    MetricDetail( metric=AnalyticsMetric.AVERAGE_SALE_PRICE, ispercentage=False, isCurrency=True, label="Average Selling Price", description="Average selling price of items sold"),
    MetricDetail( metric=AnalyticsMetric.NET_EXPENSES, ispercentage=False, isCurrency=True, label="Net Expenses", description="All Expenses including ad spend, storgae and other adjustments"),
    MetricDetail( metric=AnalyticsMetric.GROSS_EXPENSES, ispercentage=False, isCurrency=True, label="Gross Expenses", description="Fees, Shipping and other all order related expenses"),
    MetricDetail( metric=AnalyticsMetric.FEES, ispercentage=False, isCurrency=True, label="Fees++", description="Fees charged by the platform"),
    MetricDetail( metric=AnalyticsMetric.NON_FEES_EXPENSES, ispercentage=False, isCurrency=True, label="Shipping++", description="Additional adjustments or costs"),
    MetricDetail( metric=AnalyticsMetric.MISC_EXPENSES, ispercentage=False, isCurrency=True, label="Misc. Expenses", description="Total value of miscellaneous expenses"),
    MetricDetail( metric=AnalyticsMetric.PAYOUT_PER_UNIT, ispercentage=False, isCurrency=True, label="Net Payout/Unit", description="Average net revenue earned per item sold"),
    ...
    MetricDetail( metric=AnalyticsMetric.SPEND, ispercentage=False, isCurrency=True, label="Ad Spend", description="Cost incurred for ads"),
    MetricDetail( metric=AnalyticsMetric.CPC, ispercentage=False, isCurrency=True, label="CPC", description="Average cost spent for each click"),
    ...
    MetricDetail( metric=AnalyticsMetric.AD_SALES, ispercentage=False, isCurrency=True, label="Ad Sales", description="Revenue generated from ads"),
    ...
    MetricDetail( metric=AnalyticsMetric.PRE_TAX_REVENUE, ispercentage=False, isCurrency=True, label="Pre-Tax Revenue", description="Revenue before tax"),
    MetricDetail( metric=AnalyticsMetric.TAX, ispercentage=False, isCurrency=True, label="Tax Collected", description="Total tax collected on sales"),
    MetricDetail( metric=AnalyticsMetric.FBA_TAX, ispercentage=False, isCurrency=True, label="FBA Tax", description="Total FBA tax collected on sales"),
    MetricDetail( metric=AnalyticsMetric.FBM_TAX, ispercentage=False, isCurrency=True, label="FBM Tax", description="Total FBM tax collected on sales"),
    ...
    MetricDetail( metric=AnalyticsMetric.FBA_RETURN_TAX, ispercentage=False, isCurrency=True, label="FBA Return Tax", description="Total tax collected on FBA returns"),
    MetricDetail( metric=AnalyticsMetric.FBM_RETURN_TAX, ispercentage=False, isCurrency=True, label="FBM Return Tax", description="Total tax collected on FBM returns"),
    MetricDetail( metric=AnalyticsMetric.RETURN_TAX, ispercentage=False, isCurrency=True, label="Return Tax", description="Total tax collected on returns"),
    MetricDetail( metric=AnalyticsMetric.FBA_FEES, ispercentage=False, isCurrency=True, label="FBA Fees", description="Total fees charged for FBA orders"),
    MetricDetail( metric=AnalyticsMetric.FBM_FEES, ispercentage=False, isCurrency=True, label="FBM Fees", description="Total fees charged for FBM orders"),
    MetricDetail( metric=AnalyticsMetric.FBA_NON_FEES_EXPENSES, ispercentage=False, isCurrency=True, label="FBA Shipping++", description="Additional shipping or adjustment costs for FBA orders"),
    MetricDetail( metric=AnalyticsMetric.FBM_NON_FEES_EXPENSES, ispercentage=False, isCurrency=True, label="FBM Shipping++", description="Additional shipping or adjustment costs for FBM orders"),
    MetricDetail( metric=AnalyticsMetric.FBA_EXPENSES, ispercentage=False, isCurrency=True, label="FBA Expenses", description="Total expenses for FBA orders including fees and shipping++"),
    MetricDetail( metric=AnalyticsMetric.FBM_EXPENSES, ispercentage=False, isCurrency=True, label="FBM Expenses", description="Total expenses for FBM orders including fees and shipping++"),
    MetricDetail( metric=AnalyticsMetric.FBA_NET_PROCEEDS, ispercentage=False, isCurrency=True, label="FBA Net Payout", description="Net revenue from FBA orders after fees, returns, and adjustments"),
    MetricDetail( metric=AnalyticsMetric.FBM_NET_PROCEEDS, ispercentage=False, isCurrency=True, label="FBM Net Payout", description="Net revenue from FBM orders after fees, returns, and adjustments"),
    MetricDetail( metric=AnalyticsMetric.FBA_AVERAGE_SALE_PRICE, ispercentage=False, isCurrency=True, label="FBA Average Sale Price", description="Average sale price of FBA orders"),
    MetricDetail( metric=AnalyticsMetric.FBM_AVERAGE_SALE_PRICE, ispercentage=False, isCurrency=True, label="FBM Average Sale Price", description="Average sale price of FBM orders"),
    ...
    MetricDetail( metric=AnalyticsMetric.FBA_PAYOUT_PER_UNIT, ispercentage=False, isCurrency=True, label="FBA Net Payout/Unit", description="Average net revenue earned per FBA item sold"),
    MetricDetail( metric=AnalyticsMetric.FBM_PAYOUT_PER_UNIT, ispercentage=False, isCurrency=True, label="FBM Net Payout/Unit", description="Average net revenue earned per FBM item sold"),
    ...
    MetricDetail( metric=AnalyticsMetric.GROSS_PROCEEDS, ispercentage=False, isCurrency=True, label="Gross Proceeds", description="Proceeds after fees and returns but before adjustments"),
    MetricDetail( metric=AnalyticsMetric.NET_PROCEEDS, ispercentage=False, isCurrency=True, label="Net Proceeds", description="Proceeds after fees, returns, and adjustments"),
    MetricDetail( metric=AnalyticsMetric.GROSS_EXPENSES, ispercentage=False, isCurrency=True, label="Gross Profit", description="Total revenue minus cost of goods sold"),
]
...
CURRENCY_FIELDS = [d.metric.value for d in METRIC_DETAILS if d.isCurrency]
