...
from models.collections.adv_rules import AdKey, AdRule
from models.enums import AdAssetType
from models.model import ItemId, LabelValue, MarketplaceObjectId, PyObjectId
