...
#   filename:  negative_targeting_clauses.json
#   timestamp: 2025-07-23T04:03:17+00:00
...
class SponsoredProductsDeleteSponsoredProductsNegativeTargetingClausesRequestContent(
    BaseModel
):
    class Config:
        allow_population_by_field_name = True

    negative_target_id_filter: SponsoredProductsObjectIdFilter = Field(
...
class SponsoredProductsListSponsoredProductsNegativeTargetingClausesRequestContent(
    BaseModel
):
    class Config:
        allow_population_by_field_name = True

    negative_target_id_filter: SponsoredProductsObjectIdFilter | None = Field(
        None, alias='negativeTargetIdFilter'
    )
...
class SponsoredProductsCreateSponsoredProductsNegativeTargetingClausesRequestContent(
    BaseModel
):
    class Config:
        allow_population_by_field_name = True

    negative_targeting_clauses: list[SponsoredProductsCreateNegativeTargetingClause] = (
        Field(
            ...,
            alias='negativeTargetingClauses',
...
class SponsoredProductsUpdateSponsoredProductsNegativeTargetingClausesRequestContent(
    BaseModel
):
    class Config:
        allow_population_by_field_name = True

    negative_targeting_clauses: list[SponsoredProductsUpdateNegativeTargetingClause] = (
        Field(
            ...,
            alias='negativeTargetingClauses',
...
class SponsoredProductsNegativeTargetingClause(BaseModel):
    ...
    extended_data: SponsoredProductsNegativeTargetingClauseExtendedData | None = Field(
        None, alias='extendedData'
    )


class SponsoredProductsListSponsoredProductsNegativeTargetingClausesResponseContent(
    BaseModel
):
    class Config:
        allow_population_by_field_name = True
    ...
    negative_targeting_clauses: (
        list[SponsoredProductsNegativeTargetingClause] | None
    ) = Field(None, alias='negativeTargetingClauses', max_length=1000, min_length=0)
...
class SponsoredProductsNegativeTargetingClauseSuccessResponseItem(BaseModel):
    ...
    target_id: str | None = Field(
        None, alias='targetId', description='the NegativeTargetingClause ID'
    )
    index: int = Field(
        ...,
    ...
    negative_targeting_clause: SponsoredProductsNegativeTargetingClause | None = Field(
        None, alias='negativeTargetingClause'
    )
...
class SponsoredProductsNegativeTargetAccessError(BaseModel):
    ...
    error_value: SponsoredProductsNegativeTargetAccessErrorSelector = Field(
        ..., alias='errorValue'
    )
...
class SponsoredProductsNegativeTargetMutationError(BaseModel):
    ...
    error_type: str = Field(..., alias='errorType', description='The type of the error')
    error_value: SponsoredProductsNegativeTargetMutationErrorSelector = Field(
        ..., alias='errorValue'
    )
...
class SponsoredProductsNegativeTargetAccessExceptionResponseContent(BaseModel):
    ...
    message: str = Field(..., description='Human readable error message')
    errors: list[SponsoredProductsNegativeTargetAccessError] | None = None
...
class SponsoredProductsNegativeTargetMutationExceptionResponseContent(BaseModel):
    ...
    code: SponsoredProductsInvalidArgumentErrorCode
    message: str = Field(..., description='Human readable error message')
    errors: list[SponsoredProductsNegativeTargetMutationError] | None = None
...
class SponsoredProductsBulkNegativeTargetingClauseOperationResponse(BaseModel):
    ...
    success: (
        list[SponsoredProductsNegativeTargetingClauseSuccessResponseItem] | None
    ) = Field(None, max_length=1000, min_length=0)
    error: list[SponsoredProductsNegativeTargetingClauseFailureResponseItem] | None = (
        Field(None, max_length=1000, min_length=0)
    )


class SponsoredProductsUpdateSponsoredProductsNegativeTargetingClausesResponseContent(
    BaseModel
):
    class Config:
        allow_population_by_field_name = True
    ...
    ) = Field(..., alias='negativeTargetingClauses')


class SponsoredProductsCreateSponsoredProductsNegativeTargetingClausesResponseContent(
    SponsoredProductsUpdateSponsoredProductsNegativeTargetingClausesResponseContent
):
    pass


class SponsoredProductsDeleteSponsoredProductsNegativeTargetingClausesResponseContent(
    SponsoredProductsUpdateSponsoredProductsNegativeTargetingClausesResponseContent
):
    pass
