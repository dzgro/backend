...
#   filename:  campaign_negative_keywords.json
#   timestamp: 2025-07-23T04:04:13+00:00
...
class SponsoredProductsDeleteSponsoredProductsCampaignNegativeKeywordsRequestContent(
    BaseModel
):
    class Config:
        allow_population_by_field_name = True

    campaign_negative_keyword_id_filter: SponsoredProductsObjectIdFilter = Field(
...
class SponsoredProductsCreateSponsoredProductsCampaignNegativeKeywordsRequestContent(
    BaseModel
):
    class Config:
        allow_population_by_field_name = True

    campaign_negative_keywords: list[SponsoredProductsCreateCampaignNegativeKeyword] = (
        Field(
            ...,
...
class SponsoredProductsUpdateSponsoredProductsCampaignNegativeKeywordsRequestContent(
    BaseModel
):
    class Config:
        allow_population_by_field_name = True

    campaign_negative_keywords: list[SponsoredProductsUpdateCampaignNegativeKeyword] = (
        Field(
            ...,
            alias='campaignNegativeKeywords',
...
class SponsoredProductsListSponsoredProductsCampaignNegativeKeywordsRequestContent(
    BaseModel
):
    class Config:
        allow_population_by_field_name = True
    ...
    campaign_negative_keyword_id_filter: SponsoredProductsObjectIdFilter | None = Field(
        None, alias='campaignNegativeKeywordIdFilter'
    )
    ...
    campaign_negative_keyword_text_filter: SponsoredProductsKeywordTextFilter | None = (
        Field(None, alias='campaignNegativeKeywordTextFilter')
    )
...
class SponsoredProductsCampaignNegativeKeyword(BaseModel):
    ...
    keyword_text: str = Field(..., alias='keywordText', description='The keyword text.')
    extended_data: SponsoredProductsCampaignNegativeKeywordExtendedData | None = Field(
...
class SponsoredProductsCampaignNegativeKeywordSuccessResponseItem(BaseModel):
    ...
    campaign_negative_keyword: SponsoredProductsCampaignNegativeKeyword | None = Field(
        None, alias='campaignNegativeKeyword'
    )
    campaign_negative_keyword_id: str | None = Field(
        None,
        alias='campaignNegativeKeywordId',
...
class SponsoredProductsCampaignNegativeKeywordAccessError(BaseModel):
    ...
    error_value: SponsoredProductsCampaignNegativeKeywordAccessErrorSelector = Field(
        ..., alias='errorValue'
    )
...
class SponsoredProductsCampaignNegativeKeywordAccessExceptionResponseContent(BaseModel):
    ...
    message: str = Field(..., description='Human readable error message')
    errors: list[SponsoredProductsCampaignNegativeKeywordAccessError] | None = None
...
class SponsoredProductsCampaignNegativeKeywordMutationError(BaseModel):
    ...
    error_type: str = Field(..., alias='errorType', description='The type of the error')
    error_value: SponsoredProductsCampaignNegativeKeywordMutationErrorSelector = Field(
        ..., alias='errorValue'
    )


class SponsoredProductsListSponsoredProductsCampaignNegativeKeywordsResponseContent(
    BaseModel
):
    class Config:
        allow_population_by_field_name = True
    ...
    campaign_negative_keywords: (
        list[SponsoredProductsCampaignNegativeKeyword] | None
    ) = Field(None, alias='campaignNegativeKeywords', max_length=1000, min_length=0)
...
class SponsoredProductsBulkCampaignNegativeKeywordOperationResponse(BaseModel):
    ...
    success: (
        list[SponsoredProductsCampaignNegativeKeywordSuccessResponseItem] | None
    ) = Field(None, max_length=1000, min_length=0)
    error: list[SponsoredProductsCampaignNegativeKeywordFailureResponseItem] | None = (
        Field(None, max_length=1000, min_length=0)
    )


class SponsoredProductsCreateSponsoredProductsCampaignNegativeKeywordsResponseContent(
    BaseModel
):
    class Config:
        allow_population_by_field_name = True
    ...
    ) = Field(..., alias='campaignNegativeKeywords')


class SponsoredProductsCampaignNegativeKeywordMutationExceptionResponseContent(
    BaseModel
):
    """
    ...
    code: SponsoredProductsInvalidArgumentErrorCode
    message: str = Field(..., description='Human readable error message')
    errors: list[SponsoredProductsCampaignNegativeKeywordMutationError] | None = None


class SponsoredProductsUpdateSponsoredProductsCampaignNegativeKeywordsResponseContent(
    SponsoredProductsCreateSponsoredProductsCampaignNegativeKeywordsResponseContent
):
    pass


class SponsoredProductsDeleteSponsoredProductsCampaignNegativeKeywordsResponseContent(
    SponsoredProductsCreateSponsoredProductsCampaignNegativeKeywordsResponseContent
):
    pass
