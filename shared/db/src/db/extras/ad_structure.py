...
from db.collections.pipelines.ad_structure import GetStructureScore, GetAdGroupsViolations, GetAdsForAdGroup, GetMatchTypesForAdGroup, GetTargetsForAdGroup
from models.enums import CollectionType
from models.extras.ad_structure import AdGroupOptimizationRequest, AdGroupOptimizationResponse, RemoveMultipleAdsForm, RemoveMatchTypesForm, RemoveKeywordStuffingForm
...
class AdStructureHelper:
    ...
    def __init__(self, db: AsyncIOMotorDatabase, uid: str, marketplace: ObjectId) -> None:
        self.db = DbManager(db.get_collection(CollectionType.ADV_ASSETS), uid, marketplace)
