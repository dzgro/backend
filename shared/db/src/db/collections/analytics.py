...
from models.collections.analytics import CollateTypeAndValue
from db.collections.pipelines import Get30DaysGraph, GetPeriodData, GetMonthData, GetStateDataByMonth, GetMonthCarousel, GetListParams
...
class DashboardHelper:
    ...
    def __init__(self, db:AsyncIOMotorDatabase, uid: str, marketplace: ObjectId) -> None:
        ...
        self.uid = uid
        self.db = DbManager(db.get_collection(CollectionType.MARKETPLACES.value), uid=self.uid, marketplace=self.marketplace)
