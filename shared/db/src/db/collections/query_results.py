...
from models.collections.query_results import QueryRequest
from db.DbUtils import DbManager
from db.DataTransformer import Datatransformer
from models.enums import CollectionType, CollateType
...
class QueryResultsHelper:
    ...
    def __init__(self, db: AsyncIOMotorDatabase, uid: str, marketplace: ObjectId) -> None:
        ...
        self.db = DbManager(db.get_collection(CollectionType.QUERY_RESULTS), uid, marketplace)
