...
from models.enums import  CollectionType, MarketplaceStatus, BusinessType
from models.collections.user import BusinessDetails
...
class UserHelper:
    ...
    def __init__(self, db: AsyncIOMotorDatabase, uid: str) -> None:
        ...
        collection = db.get_collection(CollectionType.USERS.value)
    ...
    async def isMarketplaceActive(self, id: str):
        try:
            marketplace = await self.marketplaceHelper.getMarketplace(id)
