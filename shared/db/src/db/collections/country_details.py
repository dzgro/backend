...
from models.collections.country_details import CountryUrls, CountriesByRegion
from models.enums import CountryCode,AmazonAccountType, CollectionType
...
class CountryDetailsHelper:
    ...
    def __init__(self, db:AsyncIOMotorDatabase):
        self.db = DbManager(db.get_collection(CollectionType.COUNTRY_DETAILS.value))
