...
from dzgroshared.db.performance_period_results.model import ComparisonTableRequest, PerformanceTableLiteResponse, PerformanceTableResponse
...
@cache_control()
@enforce_response_model(PerformanceTableResponse)
